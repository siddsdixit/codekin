...
exports.SimpleInstaller = void 0;
...
class SimpleInstaller {
    ...
    async getModeFilePath(target) {
        if (target === "project") {
            ...
            return path.join(globalSettingsPath, globalFileNames_1.GlobalFileNames.customModes);
        }
    }
    async getMcpFilePath(target) {
        if (target === "project") {
            ...
            const globalSettingsPath = await (0, globalContext_1.ensureSettingsDirectoryExists)(this.context);
            return path.join(globalSettingsPath, globalFileNames_1.GlobalFileNames.mcpSettings);
        }
    }
}
exports.SimpleInstaller = SimpleInstaller;
