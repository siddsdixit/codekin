...
class QdrantVectorStore {
    ...
    async initialize() {
        ...
        try {
            ...
            throw new Error((0, i18n_1.t)("embeddings:vectorStore.qdrantConnectionFailed", { qdrantUrl: this.qdrantUrl, errorMessage }));
        }
    }
    /**
    ...
    async _recreateCollectionWithNewDimension(existingVectorSize) {
        ...
        try {
            ...
            const dimensionMismatchError = new Error((0, i18n_1.t)("embeddings:vectorStore.vectorDimensionMismatch", {
