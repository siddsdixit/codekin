...
async function parseSourceCodeDefinitionsForFile(filePath, rooIgnoreController) {
...
async function parseSourceCodeForDefinitionsTopLevel(dirPath, rooIgnoreController) {
    ...
    const languageParsers = await (0, languageParser_1.loadRequiredLanguageParsers)(otherFiles);
