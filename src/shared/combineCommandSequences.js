...
const safeJsonParse_1 = require("./safeJsonParse");
    ...
    for (let i = 0; i < messages.length; i++) {
        ...
        if (msg.type === "ask" && msg.ask === "use_mcp_server") {
            ...
            if (responses.length > 0) {
                ...
                const jsonObj = (0, safeJsonParse_1.safeJsonParse)(msg.text || "{}", {});
            ...
            while (j < messages.length) {
                ...
                if (ask === "command_output" || say === "command_output") {
                    ...
                    if (text.length > 0 && !isDuplicate) {
                        ...
                        if (previous &&
                            combinedText.length >
                                combinedText.indexOf(exports.COMMAND_OUTPUT_STRING) + exports.COMMAND_OUTPUT_STRING.length) {
                            combinedText += "\n";
                        }
                        combinedText += text;
                    }
