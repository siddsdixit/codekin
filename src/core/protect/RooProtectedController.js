...
exports.RooProtectedController = exports.SHIELD_SYMBOL = void 0;
...
class RooProtectedController {
    ...
    getInstructions() {
        ...
        return `# Protected Files\n\n(The following Roo configuration file patterns are write-protected and always require approval for modifications, regardless of autoapproval settings. When using list_files, you'll notice a ${exports.SHIELD_SYMBOL} next to files that are write-protected.)\n\nProtected patterns: ${patterns}`;
    }
    /**
...
exports.RooProtectedController = RooProtectedController;
