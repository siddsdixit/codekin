...
exports.tryChromeHostUrl = tryChromeHostUrl;
exports.getDockerHostIP = getDockerHostIP;
exports.scanNetworkForChrome = scanNetworkForChrome;
exports.discoverChromeHostUrl = discoverChromeHostUrl;
 ...
 */
async function tryChromeHostUrl(chromeHostUrl) {
    try {
        console.log(`Trying to connect to Chrome at: ${chromeHostUrl}/json/version`);
        await axios_1.default.get(`${chromeHostUrl}/json/version`, { timeout: 1000 });
        return true;
    }
    catch (error) {
        return false;
 ...
 * Get Docker host IP
 */
async function getDockerHostIP() {
    try {
 ...
 */
async function scanNetworkForChrome(baseIP, port) {
 ...
 */
async function discoverChromeHostUrl(port = 9222) {
