export declare const scannerExtensions: string[];
/**
 ...
 */
export declare function shouldUseFallbackChunking(extension: string): boolean;
//# sourceMappingURL=supported-extensions.d.ts.map