...
const Disassembler_1 = __importDefault(require("stream-json/Disassembler"));
const Stringer_1 = __importDefault(require("stream-json/Stringer"));
/**
...
async function _streamDataToFile(targetPath, data) {
    ...
    const disassembler = Disassembler_1.default.disassembler();
    // Output will be compact JSON as standard Stringer is used.
    const stringer = Stringer_1.default.stringer();
