...
class AwsBedrockHandler extends base_provider_1.BaseProvider {
    ...
    constructor(options) {
        ...
        const clientConfig = {
            userAgentAppId: `RooCode#${package_1.Package.version}`,
    ...
    async *createMessage(systemPrompt, messages, metadata) {
        ...
        const isThinkingEnabledBySettings = (0, api_1.shouldUseReasoningBudget)({ model: modelConfig.info, settings: this.options }) &&
        ...
        const is1MContextEnabled = types_1.BEDROCK_1M_CONTEXT_MODEL_IDS.includes(baseModelId) && this.options.awsBedrock1MContext;
    ...
    async completePrompt(prompt) {
        try {
            ...
            const thinkingEnabled = (0, api_1.shouldUseReasoningBudget)({ model: modelConfig.info, settings: this.options }) &&
                modelConfig.reasoning &&
                modelConfig.reasoningBudget;
            const inferenceConfig = {
                maxTokens: modelConfig.maxTokens || modelConfig.info.maxTokens,
