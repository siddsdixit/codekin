...
exports.MultiFileSearchReplaceDiffStrategy = void 0;
...
class MultiFileSearchReplaceDiffStrategy {
    fuzzyThreshold;
    bufferLines;
    getName() {
    ...
    async applySingleDiff(originalContent, diffContent, _paramStartLine) {
        ...
        */
        ...
        for (const replacement of replacements) {
            ...
            const hasAllLineNumbers = ((0, extract_text_1.everyLineHasLineNumbers)(searchContent) && (0, extract_text_1.everyLineHasLineNumbers)(replaceContent)) ||
            ...
            if (matchIndex === -1 || bestMatchScore < this.fuzzyThreshold) {
                ...
                if (bestMatchIndex !== -1 && bestScore >= this.fuzzyThreshold) {
                    ...
                    const originalContentSection = startLine !== undefined && endLine !== undefined
                        ? `\n\nOriginal Content:\n${(0, extract_text_1.addLineNumbers)(resultLines
...
exports.MultiFileSearchReplaceDiffStrategy = MultiFileSearchReplaceDiffStrategy;
