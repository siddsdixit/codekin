...
class BaseTerminal {
    ...
    static compressTerminalOutput(input, lineLimit, characterLimit) {
        ...
        if (BaseTerminal.compressProgressBar) {
            processedInput = (0, extract_text_1.processCarriageReturns)(processedInput);
            processedInput = (0, extract_text_1.processBackspaces)(processedInput);
        }
        // Default character limit to prevent context window explosion
        const effectiveCharLimit = characterLimit ?? types_1.DEFAULT_TERMINAL_OUTPUT_CHARACTER_LIMIT;
        return (0, extract_text_1.truncateOutput)((0, extract_text_1.applyRunLengthEncoding)(processedInput), lineLimit, effectiveCharLimit);
    }
    /**
